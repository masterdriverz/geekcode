...
#define DEPENDANT(name)			{-1, 1, #name, name, 1},
#define LINE_END			{0,  0, NULL,  NULL, 0}

struct stuff2 line1[] = {
	INDEPENDANT(gc_type)
	INDEPENDANT(gc_dress)
	INDEPENDANT(gc_height)
	INDEPENDANT(gc_weight)
	INDEPENDANT(gc_age)
	INDEPENDANT(gc_computers)
	HIDDEN(gc_unix_type)
	DEPENDANT(gc_unix)
	INDEPENDANT(gc_perl)
	INDEPENDANT(gc_linux)
	INDEPENDANT(gc_emacs)
	INDEPENDANT(gc_www)
	INDEPENDANT(gc_usenet)
	INDEPENDANT(gc_oracle)
	INDEPENDANT(gc_kibo)
	INDEPENDANT(gc_windows)
	LINE_END
};
...
struct stuff2 line2[] = {
	...
	INDEPENDANT(gc_mac)
	INDEPENDANT(gc_vms)
	INDEPENDANT(gc_social)
	INDEPENDANT(gc_economic)
	INDEPENDANT(gc_cypher)
	INDEPENDANT(gc_pgp)
	INDEPENDANT(gc_startrek)
	INDEPENDANT(gc_babylon5)
	INDEPENDANT(gc_xfiles)
	INDEPENDANT(gc_rp)
	INDEPENDANT(gc_television)
	INDEPENDANT(gc_books)
	INDEPENDANT(gc_dilbert)
	INDEPENDANT(gc_doom)
	LINE_END
};

struct stuff2 line3[] = {
	INDEPENDANT(gc_geekcode)
	INDEPENDANT(gc_education)
	INDEPENDANT(gc_housing)
	INDEPENDANT(gc_relationships)
	HIDDEN(gc_gender)
	DEPENDANT(gc_sex)
	LINE_END
};
